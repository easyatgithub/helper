...
import { executeJavaScript, sendKeys, waitElementFocused } from "./utils/seleniumHelper";
...
export default class {
  ...
  async fillTransferFrom() {
    try {
      ...
      await waitElementFocused(this.driver, nameField);
      await sendKeys(nameField, { text: this.task.receiverName });
      ...
      // receiver account
      await waitElementFocused(this.driver, accountField);
      await sendKeys(accountField, {
      ...
      if (provinceStyle !== "display: none;") {
        ...
        await sendKeys(bankField, { text: this.bankMapppingList[this.task.bank.chineseName] });
      ...
      await waitElementFocused(this.driver, amountField);
      await sendKeys(amountField, {
